...
namespace DotNetMigrations.Core.Data
{
	public class DataAccessFactory
	{
		...
		/// </summary>
		public static DataAccess Create(string connectionString, ILogger logger)
		{
			...
			var da = new DataAccess(GetFactory(provider), csb.ConnectionString, provider, commandTimeout ?? 600, logger);
			return da;
		}
