...
namespace DotNetMigrations.Core
{
	public static class AppSettingKeys
	{
		...
		/// <summary>
		/// Defines which script modifiers will be executed
		/// </summary>
		public const string ActiveScriptPreprocessors = "activeScriptPreprocessors";

		/// <summary>
		/// Defines an environment to allow targeting scripts to specific environments
		/// </summary>
